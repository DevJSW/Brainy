 ...
 */
public class ViewAnsProfileTab extends Fragment {
    ...
    private void LoadMessage() {
        ...
        Query quizQuery = mDatabaseAnswers.child(UserId).limitToLast(currentPage * TOTAL_ITEMS_TO_LOAD);
